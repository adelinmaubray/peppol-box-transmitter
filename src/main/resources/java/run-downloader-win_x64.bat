@echo off
REM Run the downloader using the bundled Windows x64 JRE
REM Usage: run-downloader-win_x64.bat path\to\properties.file
...
"%JAVA_BIN%" -jar "%JAR_FILE%" --action=download --properties="%PROPS%"
exit /b %errorlevel%
