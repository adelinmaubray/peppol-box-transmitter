@echo off
REM Run the sender using the bundled Windows x64 JRE
REM Usage: run-sender-win_x64.bat path\to\properties.file
...
"%JAVA_BIN%" -jar "%JAR_FILE%" --action=send --properties="%PROPS%"
exit /b %errorlevel%
